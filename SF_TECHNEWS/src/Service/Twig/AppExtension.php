...
class AppExtension extends AbstractExtension
{
    ...
    public function getFilters()
    {
        return [
            ...
            }), # -- Fin de Twig Filter catlink

            new \Twig_Filter('autlink', function(Auteur $auteur) {
                return $this->router->generate('index_auteur', [
                    'nomauteur'  => $this->slugify($auteur->getNom())
                ]);
            }) # -- Fin de Twig Filter autlink
